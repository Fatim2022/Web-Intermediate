...
export function generateMainNavigationListTemplate() {
  return `
    ...
    <li><a id="bookmark-button" class="bookmark-button" href="#/bookmark">History</a></li>
  `;
}
...
export function generateAuthenticatedNavigationListTemplate() {
  return `
    <li id="push-notification-tools" class="push-notification-tools"></li>
    <li><a id="new-report-button" class="btn new-report-button" href="#/new">Add <i class="fas fa-plus"></i></a></li>
...
export function generateReportsListEmptyTemplate() {
  return `
    <div id="reports-list-empty" class="reports-list__empty">
      ...
      <p>Saat ini, tidak cerita yang dapat ditampilkan.</p>
    </div>
  `;
}
